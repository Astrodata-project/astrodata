...
if __name__ == "__main__":
    # Example usage
    config = read_config("examples/data/example_config_params.yaml")
    processors = instantiate_processors(config["preml"], ignore_unknown=True)
    print(processors)
    # This will print the instantiated processor objects based on the config.
